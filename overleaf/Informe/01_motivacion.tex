...
El objetivo de este trabajo es construir un sistema reproducible, completamente implementado en PyTorch y alineado con los entregables del examen parcial. En particular, el repositorio desarrolla una U-Net desde cero, incorpora variantes con compuertas de atención y \emph{nested skip connections}, compara decisiones de entrenamiento mediante ablación, evalúa la generalización entre datasets y analiza tipos de fallo desde una perspectiva arquitectónica.
...
\begin{itemize}
    ...
    \item Experimento DRIVE $\rightarrow$ CHASE\_DB1 para cuantificar la brecha de generalización.
    \item Análisis cualitativo de fallos por tipo de vaso.
    \item Evidencia de una estrategia de adaptación de dominio basada en preprocesamiento y TTA.
\end{itemize}
